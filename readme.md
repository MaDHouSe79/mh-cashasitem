...
- it looks like the js files are compressed so you can't edit this js files, and thats why mh-cashasitem can't support ph-hud or other ps scripts.
- i ask for it but they closed the ticket and didn't even responds to it, they say this script is not good and will break the economy, but every server i use this script did not.
